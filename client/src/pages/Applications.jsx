...
const Applications = () => {
  ...
  const { backendUrl, userData, userApplications, fetchUserData, fetchUserApplications, userDataLoading, userToken } = useContext(AppContext)
  ...
  // If user is logged in but userData doesn't exist, show message
    ...
    return (
      <>
        ...
        <div className='container px-4 min-h-[65vh] 2xl:px-20 mx-auto my-10 text-center'>
          ...
          <p className='text-gray-600'>Please wait while we create your account. This usually takes a few seconds.</p>
          <p className='text-gray-500 mt-2'>If this takes too long, try refreshing the page.</p>
        </div>
        <Footer />
      </>
    )
