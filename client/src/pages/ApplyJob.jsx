...
const ApplyJob = () => {
  ...
  const { jobs, backendUrl, userData, userApplications, fetchUserApplications, userDataLoading, userToken, setShowUserLogin } = useContext(AppContext)
  ...
  const applyHandler = async () => {
    try {
      ...
      // Fetch fresh user data to check for resume
      const { data: userDataResponse } = await axios.get(backendUrl + '/api/users/user',
      ...
      const freshUserData = userDataResponse.user

      if (!freshUserData.resume) {
